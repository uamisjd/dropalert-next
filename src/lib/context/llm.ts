...
function buildPrompt(input: ContextRequestInput): string {
  return [
    ...
    "- forma_recente_5: le ULTIME CINQUE partite di ciascuna squadra in sintesi (es. \"casa: 3V 1N 1P; trasferta: 1V 1N 3P\"), con la posizione in classifica se nota",
    "- assenze_note: infortuni, squalifiche o assenze dichiarate alla vigilia, con il nome del giocatore se noto; \"non noto\" se le fonti non ne parlano",
    'L\'ultimo campo è una stringa: accordo_col_drop, esattamente uno fra "sostiene", "contraddice", "non c\'entra",',
    "  sul se questo contesto sostiene, contraddice o non c'entra col movimento di quota osservato sopra.",
    "Regole di lingua: italiano corretto, con le elisioni obbligatorie davanti a vocale",
    "  (\"dell'Australia Cup\", mai \"della Australia Cup\"; \"nell'ultimo turno\", \"all'andata\",",
    "  \"un'amichevole\"). Non scrivere mai la preposizione articolata non elisa davanti a vocale.",
